#***************************************************************************************************
# **  文件名称： dm_ups_food_info_h2c_prod_bjc1_create.sql
# **  功能描述： 创建食品画像Cassandra链接表 线上环境
#
...
DROP TABLE dm_test.dm_ups_food_info_h2c_prod_bjc1;
CREATE EXTERNAL TABLE dm_test.dm_ups_food_info_h2c_prod_bjc1
( 
  food_id bigint,
  name string,
