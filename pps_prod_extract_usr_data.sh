...
hive -e "
    select
        concat(
            concat('user_id','\003',if(user_id is not null, user_id ,'_N_')),'\001',
            concat('email','\003',if(email is not null, email ,'_N_')),'\002',
            concat('gender','\003',if(gender is not null, gender ,'_N_')),'\002',
            concat('nick_name','\003',if(nick_name is not null, nick_name ,'_N_')),'\002',
            concat('pre_phone','\003',if(pre_phone is not null, pre_phone ,'_N_')),'\002',
            concat('create_time','\003',if(create_time is not null, create_time ,'_N_')),'\002',
            concat('source','\003',if(source is not null, source ,'_N_')),'\002',
            concat('brand','\003',if(brand is not null, brand ,'_N_')),'\002',
            concat('os_platform','\003',if(os_platform is not null, os_platform ,'_N_')),'\002',
            concat('os_version','\003',if(os_version is not null, os_version ,'_N_')),'\002',
            concat('model','\003',if(model is not null, model ,'_N_')),'\002',
            concat('id','\003',if(id is not null, id ,'_N_')),'\002',
            concat('resolution','\003',if(resolution is not null, resolution ,'_N_')),'\002',
            concat('category_prefer','\003',if(category_prefer is not null, category_prefer ,'_N_')),'\002',
            concat('hongbao_sensitive','\003',if(hongbao_sensitive is not null, hongbao_sensitive ,'_N_')),'\002',
            concat('price_sensitive','\003',if(price_sensitive is not null, price_sensitive ,'_N_')),'\002',
            concat('style_prefer','\003',if(style_prefer is not null, style_prefer ,'_N_')),'\002',
            concat('flavor_prefer','\003',if(flavor_prefer is not null, flavor_prefer ,'_N_')),'\002',
            concat('food_prefer','\003',if(food_prefer is not null, food_prefer ,'_N_')),'\002',
            concat('visit_address','\003',if(visit_address is not null, visit_address ,'_N_')),'\002',
            concat('last_visit_time','\003',if(last_visit_time is not null, last_visit_time ,'_N_')),'\002',
            concat('visit_time_prefer','\003',if(visit_time_prefer is not null, visit_time_prefer ,'_N_')),'\002',
            concat('visit_date_prefer','\003',if(visit_date_prefer is not null, visit_date_prefer ,'_N_')),'\002',
            concat('visit_province_id','\003',if(visit_province_id is not null, visit_province_id ,'_N_')),'\002',
            concat('first_visit_time','\003',if(first_visit_time is not null, first_visit_time ,'_N_')),'\002',
            concat('visit_city_id','\003',if(visit_city_id is not null, visit_city_id ,'_N_')),'\002',
            concat('order_subsidy','\003',if(order_subsidy is not null, order_subsidy ,'_N_')),'\002',
            concat('order_address','\003',if(order_address is not null, order_address ,'_N_')),'\002',
            concat('first_order_time','\003',if(first_order_time is not null, first_order_time ,'_N_')),'\002',
            concat('last_order_time','\003',if(last_order_time is not null, last_order_time ,'_N_')),'\002',
            concat('order_date_prefer','\003',if(order_date_prefer is not null, order_date_prefer ,'_N_')),'\002',
            concat('order_cnt','\003',if(order_cnt is not null, order_cnt ,'_N_')),'\002',
            concat('consume_level','\003',if(consume_level is not null, consume_level ,'_N_')),'\002',
            concat('order_avg_fee','\003',if(order_avg_fee is not null, order_avg_fee ,'_N_')),'\002',
            concat('order_province_id','\003',if(order_province_id is not null, order_province_id ,'_N_')),'\002',
            concat('order_hongbao','\003',if(order_hongbao is not null, order_hongbao ,'_N_')),'\002',
            concat('order_bu_flag','\003',if(order_bu_flag is not null, order_bu_flag ,'_N_')),'\002',
            concat('order_amt','\003',if(order_amt is not null, order_amt ,'_N_')),'\002',
            concat('point','\003',if(point is not null, point ,'_N_')),'\002',
            concat('order_time_prefer','\003',if(order_time_prefer is not null, order_time_prefer ,'_N_')),'\002',
            concat('order_city_id','\003',if(order_city_id is not null, order_city_id ,'_N_')),'\002',
            concat('is_sia','\003',if(is_sia is not null, is_sia ,'_N_')),'\002',
            concat('phone_number','\003',if(phone_number is not null, phone_number ,'_N_')),'\002',
            concat('delivery_type_prefer','\003',if(delivery_type_prefer is not null, delivery_type_prefer ,'_N_')),'\002',
            concat('recent_30_avg_delivery_fee','\003',if(recent_30_avg_delivery_fee is not null, recent_30_avg_delivery_fee ,'_N_')),'\002',
            concat('collect_rest_list','\003',if(collect_rest_list is not null, collect_rest_list ,'_N_')),'\002',
            concat('click_rest_list','\003',if(click_rest_list is not null, click_rest_list ,'_N_')),'\002',
            concat('order_rest_list','\003',if(order_rest_list is not null, order_rest_list ,'_N_')),'\002',
            concat('score_rest_list','\003',if(score_rest_list is not null, score_rest_list ,'_N_')),'\002',
            concat('order_again_rest_list','\003',if(order_again_rest_list is not null, order_again_rest_list ,'_N_')),'\002',
            concat('recent_30_active_day','\003',if(recent_30_active_day is not null, recent_30_active_day ,'_N_')),'\002',
            concat('recent_30_play_time','\003',if(recent_30_play_time is not null, recent_30_play_time ,'_N_')),'\002',
            ...
            concat('delivery_priority','\003',if(delivery_priority is not null, delivery_priority ,'_N_')),'\002',
            concat('is_vip','\003',if(is_vip is not null, is_vip ,'_N_')),'\002',
            concat('phone_city_id','\003',if(phone_city_id is not null, phone_city_id ,'_N_')),'\002',
            concat('phone_city_name','\003',if(phone_city_name is not null, phone_city_name ,'_N_')),'\002',
            concat('phone_province_id','\003',if(phone_province_id is not null, phone_province_id ,'_N_')),'\002',
            concat('phone_province_name','\003',if(phone_province_name is not null, phone_province_name ,'_N_')),'\002',
            concat('hongbao_balance','\003',if(hongbao_balance is not null, hongbao_balance ,'_N_')),'\002',
            concat('recent_7_reminder_order_num','\003',if(recent_7_reminder_order_num is not null, recent_7_reminder_order_num ,'_N_')),'\002',
            concat('recent_7_reminder_order_rate','\003',if(recent_7_reminder_order_rate is not null, recent_7_reminder_order_rate ,'_N_')),'\002',
            concat('recent_7_withdraw_order_num','\003',if(recent_7_withdraw_order_num is not null, recent_7_withdraw_order_num ,'_N_')),'\002',
            concat('recent_7_withdraw_order_rate','\003',if(recent_7_withdraw_order_rate is not null, recent_7_withdraw_order_rate ,'_N_')),'\002',
            concat('rest_distance_avg','\003',if(rest_distance_avg is not null, rest_distance_avg ,'_N_')),'\002',
            concat('order_discount_rate','\003',if(order_discount_rate is not null, order_discount_rate ,'_N_')),'\002',
            concat('order_manjian_rate','\003',if(order_manjian_rate is not null, order_manjian_rate ,'_N_')),'\002',
            concat('recent_90_click_premium_rest_rate','\003',if(recent_90_click_premium_rest_rate is not null, recent_90_click_premium_rest_rate ,'_N_')),'\002',
            concat('recent_90_visit_dish_per_rest_avg','\003',if(recent_90_visit_dish_per_rest_avg is not null, recent_90_visit_dish_per_rest_avg ,'_N_')),'\002',
            concat('recent_30_is_new','\003',if(recent_30_is_new is not null, recent_30_is_new ,'_N_')),'\002',
            concat('order_interval_avg','\003',if(order_interval_avg is not null, order_interval_avg ,'_N_')),'\002',
            concat('order_interval_min','\003',if(order_interval_min is not null, order_interval_min ,'_N_')),'\002',
            concat('order_delivery_fee_rate','\003',if(order_delivery_fee_rate is not null, order_delivery_fee_rate ,'_N_')),'\002',
            concat('click_rest_sale_avg','\003',if(click_rest_sale_avg is not null, click_rest_sale_avg ,'_N_')),'\002',
            concat('click_rest_open_time_avg','\003',if(click_rest_open_time_avg is not null, click_rest_open_time_avg ,'_N_')),'\002',
            concat('click_rest_safety_level_avg','\003',if(click_rest_safety_level_avg is not null, click_rest_safety_level_avg ,'_N_')),'\002',
            concat('click_rest_score_avg','\003',if(click_rest_score_avg is not null, click_rest_score_avg ,'_N_')),'\002',
            concat('click_rest_desc_length_avg','\003',if(click_rest_desc_length_avg is not null, click_rest_desc_length_avg ,'_N_')),'\002',
            concat('click_rest_delivery_time_avg','\003',if(click_rest_delivery_time_avg is not null, click_rest_delivery_time_avg ,'_N_')),'\002',
            concat('click_rest_has_picture_rate','\003',if(click_rest_has_picture_rate is not null, click_rest_has_picture_rate ,'_N_')),'\002',
            concat('click_rest_discount_avg','\003',if(click_rest_discount_avg is not null, click_rest_discount_avg ,'_N_')),'\002',
            concat('rest_order_cat0_prefer','\003',if(rest_order_cat0_prefer is not null, rest_order_cat0_prefer ,'_N_')),'\002',
            concat('rest_order_cat1_prefer','\003',if(rest_order_cat1_prefer is not null, rest_order_cat1_prefer ,'_N_')),'\002',
            concat('rest_behavior','\003',if(rest_behavior is not null, rest_behavior ,'_N_')),'\002',
            concat('cat_profile','\003',if(cat_profile is not null, cat_profile ,'_N_')),'\002',
            concat('rest_prefer','\003',if(rest_prefer is not null, rest_prefer ,'_N_'))
        )
    from(    
        select
