#***************************************************************************************************
# **  文件名称： dm_ups_taker_info_h2c_alpha_create.sql
# **  功能描述： 创建骑手画像Cassandra链接表 alpha环境
#
...
DROP TABLE dm_test.dm_ups_taker_info_h2c_alpha;
CREATE EXTERNAL TABLE dm_test.dm_ups_taker_info_h2c_alpha
( 
  taker_id bigint,
  city_id int,
  created_at string,
