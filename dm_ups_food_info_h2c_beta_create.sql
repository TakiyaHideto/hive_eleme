#***************************************************************************************************
# **  文件名称： dm_ups_food_info_h2c_beta_create.sql
# **  功能描述： 创建食品画像Cassandra链接表 beta环境
#
...
DROP TABLE dm_test.dm_ups_food_info_h2c_beta;
CREATE EXTERNAL TABLE dm_test.dm_ups_food_info_h2c_beta
( 
  food_id bigint,
  name string,
