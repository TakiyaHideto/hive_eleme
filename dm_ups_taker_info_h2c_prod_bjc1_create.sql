#***************************************************************************************************
# **  文件名称： dm_ups_taker_info_h2c_prod_bjc1_create.sql
# **  功能描述： 创建骑手画像Cassandra链接表 线上环境
#
...
DROP TABLE dm_test.dm_ups_taker_info_h2c_prod_bjc1;
CREATE EXTERNAL TABLE dm_test.dm_ups_taker_info_h2c_prod_bjc1
( 
  taker_id bigint,
  city_id int,
  created_at string,
