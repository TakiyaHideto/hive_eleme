...
create table temp.temp_mdl_rst_subsidy_strategy as 
    ...
    join(
        select
            ...
            a.is_premium,
            a.geo_cluster,
            bound_data(b.total_percentile_8,0,150) as total_percentile_8_rst,
            bound_data(b.total_percentile_5,0,150) as total_percentile_5_rst,
            bound_data(b.total_percentile_3,0,150) as total_percentile_3_rst,
            bound_data(c.total_percentile_8,0,150) as total_percentile_8_geo,
            bound_data(c.total_percentile_5,0,150) as total_percentile_5_geo,
            bound_data(c.total_percentile_3,0,150) as total_percentile_3_geo
        from(
            select 
                id as restaurant_id,
                is_premium,
        ...
        join(
            select
                restaurant_id,
                bound_data(percentile_approx(total,0.8),0,150) as total_percentile_8,
                bound_data(percentile_approx(total,0.5),0,150) as total_percentile_5,
                bound_data(percentile_approx(total,0.3),0,150) as total_percentile_3
            from
                dw.dw_trd_order_wide
            where
                dt='${day}' and
