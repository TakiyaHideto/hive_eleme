...
select 
    concat(
        ...
        concat('name','\003',if(name is not null, name ,'null')),'\002',
        concat('address','\003',if(address is not null, address ,'null')),'\002',
        concat('restaurant_type','\003',if(restaurant_type is not null, restaurant_type ,'null')),'\002',
        ...
        concat('city_name','\003',if(city_name is not null, city_name ,'null')),'\002',
        concat('min_deliver_amt','\003',if(min_deliver_amt is not null, min_deliver_amt ,'null')),'\002',
        concat('bu_flag','\003',if(bu_flag is not null, bu_flag ,'null')),'\002',
        concat('time_ensure_spent','\003',if(time_ensure_spent is not null, time_ensure_spent ,'null')),'\002',
        concat('time_ensure_discount','\003',if(time_ensure_discount is not null, time_ensure_discount ,'null')),'\002',
        concat('deliver_type','\003',if(deliver_type is not null, deliver_type ,'null')),'\002',
        concat('food_number','\003',if(food_number is not null, food_number ,'null')),'\002',
        concat('has_license','\003',if(has_license is not null, has_license ,'null')),'\002',
        concat('has_service_license','\003',if(has_service_license is not null, has_service_license ,'null')),'\002',
        concat('is_exclusive','\003',if(is_exclusive is not null, is_exclusive ,'null')),'\002',
        concat('is_sia','\003',if(is_sia is not null, is_sia ,'null')),'\002',
        concat('cat0_name','\003',if(cat0_name is not null, cat0_name ,'null')),'\002',
        concat('cat1_name','\003',if(cat1_name is not null, cat1_name ,'null')),'\002',
        concat('recent_7_open_days','\003',if(recent_7_open_days is not null, recent_7_open_days ,'null')),'\002',
        concat('recent_30_open_days','\003',if(recent_30_open_days is not null, recent_30_open_days ,'null')),'\002',
        concat('recent_7_open_hours','\003',if(recent_7_open_hours is not null, recent_7_open_hours ,'null')),'\002',
        concat('recent_30_open_hours','\003',if(recent_30_open_hours is not null, recent_30_open_hours ,'null')),'\002',
        concat('recent_7_order_complain_cnt','\003',if(recent_7_order_complain_cnt is not null, recent_7_order_complain_cnt ,'null')),'\002',
        concat('recent_30_order_complain_cnt','\003',if(recent_30_order_complain_cnt is not null, recent_30_order_complain_cnt ,'null')),'\002',
        concat('recent_7_order_remind_cnt','\003',if(recent_7_order_remind_cnt is not null, recent_7_order_remind_cnt ,'null')),'\002',
        concat('recent_30_order_remind_cnt','\003',if(recent_30_order_remind_cnt is not null, recent_30_order_remind_cnt ,'null')),'\002',
        concat('recent_7_user_refuse_order_cnt','\003',if(recent_7_user_refuse_order_cnt is not null, recent_7_user_refuse_order_cnt ,'null')),'\002',
        concat('recent_30_user_refuse_order_cnt','\003',if(recent_30_user_refuse_order_cnt is not null, recent_30_user_refuse_order_cnt ,'null')),'\002',
        concat('recent_7_rst_refuse_order_cnt','\003',if(recent_7_rst_refuse_order_cnt is not null, recent_7_rst_refuse_order_cnt ,'null')),'\002',
        concat('recent_30_rst_refuse_order_cnt','\003',if(recent_30_rst_refuse_order_cnt is not null, recent_30_rst_refuse_order_cnt ,'null')),'\002',
        concat('star_rating_5_cnt','\003',if(star_rating_5_cnt is not null, star_rating_5_cnt ,'null')),'\002',
        concat('star_rating_4_cnt','\003',if(star_rating_4_cnt is not null, star_rating_4_cnt ,'null')),'\002',
        concat('star_rating_3_cnt','\003',if(star_rating_3_cnt is not null, star_rating_3_cnt ,'null')),'\002',
        concat('star_rating_2_cnt','\003',if(star_rating_2_cnt is not null, star_rating_2_cnt ,'null')),'\002',
        concat('star_rating_1_cnt','\003',if(star_rating_1_cnt is not null, star_rating_1_cnt ,'null')),'\002',
        concat('recent_7_order_cnt','\003',if(recent_7_order_cnt is not null, recent_7_order_cnt ,'null')),'\002',
        concat('recent_30_order_cnt','\003',if(recent_30_order_cnt is not null, recent_30_order_cnt ,'null')),'\002',
        concat('recent_7_user_cnt','\003',if(recent_7_user_cnt is not null, recent_7_user_cnt ,'null')),'\002',
        concat('recent_30_user_cnt','\003',if(recent_30_user_cnt is not null, recent_30_user_cnt ,'null')),'\002',
        concat('recent_7_ord_usr_ratio','\003',if(recent_7_ord_usr_ratio is not null, recent_7_ord_usr_ratio ,'null')),'\002',
        concat('recent_30_ord_usr_ratio','\003',if(recent_30_ord_usr_ratio is not null, recent_30_ord_usr_ratio ,'null')),'\002',
        concat('recent_7_returned_customer_scale','\003',if(recent_7_returned_customer_scale is not null, recent_7_returned_customer_scale ,'null')),'\002',
        concat('recent_30_returned_customer_scale','\003',if(recent_30_returned_customer_scale is not null, recent_30_returned_customer_scale ,'null')),'\002',
        ...
        concat('recent_30_order_price_median','\003',if(recent_30_order_price_median is not null, recent_30_order_price_median ,'null')),'\002',
        concat('recent_30_order_price_stddev','\003',if(recent_30_order_price_stddev is not null, recent_30_order_price_stddev ,'null')),'\002',
        concat('recent_30_payment_amt','\003',if(recent_30_payment_amt is not null, recent_30_payment_amt ,'null')),'\002',
        concat('recent_30_payment_median','\003',if(recent_30_payment_median is not null, recent_30_payment_median ,'null')),'\002',
        concat('recent_30_payment_stddev','\003',if(recent_30_payment_stddev is not null, recent_30_payment_stddev ,'null')),'\002',
        concat('recent_30_eleme_subsidy_amt','\003',if(recent_30_eleme_subsidy_amt is not null, recent_30_eleme_subsidy_amt ,'null')),'\002',
        concat('recent_30_eleme_subsidy_median','\003',if(recent_30_eleme_subsidy_median is not null, recent_30_eleme_subsidy_median ,'null')),'\002',
        concat('recent_30_eleme_subsidy_stddev','\003',if(recent_30_eleme_subsidy_stddev is not null, recent_30_eleme_subsidy_stddev ,'null')),'\002',
        concat('recent_30_order_chargeback_scale','\003',if(recent_30_order_chargeback_scale is not null, recent_30_order_chargeback_scale ,'null')),'\002',
        concat('recent_30_order_unpaid_cnt','\003',if(recent_30_order_unpaid_cnt is not null, recent_30_order_unpaid_cnt ,'null')),'\002',
        concat('recent_30_order_unpaid_scale','\003',if(recent_30_order_unpaid_scale is not null, recent_30_order_unpaid_scale ,'null')),'\002',
        concat('recent_7_order_hongbao_preferential_avg','\003',if(recent_7_order_hongbao_preferential_avg is not null, recent_7_order_hongbao_preferential_avg ,'null')),'\002',
        concat('recent_7_order_hongbao_preferential_stddev','\003',if(recent_7_order_hongbao_preferential_stddev is not null, recent_7_order_hongbao_preferential_stddev ,'null')),'\002',
        ...
        concat('order_month_distribution','\003',if(order_month_distribution is not null, order_month_distribution ,'null')),'\002',
        concat('food_top_10','\003',if(food_top_10 is not null, food_top_10 ,'null')),'\002',
        concat('rest_food_cate_distribution','\003', if(rest_food_cate_distribution is not null, rest_food_cate_distribution, 'null')),'\002',
        concat('recent_30_alltime_exp_ctr','\003', if(recent_30_alltime_exp_ctr is not null, recent_30_alltime_exp_ctr, 'null')),'\002',
        concat('recent_30_alltime_exp_cnt','\003', if(recent_30_alltime_exp_cnt is not null, recent_30_alltime_exp_cnt, 'null')),'\002',
        concat('recent_30_meal_exp_ctr','\003', if(recent_30_meal_exp_ctr is not null, recent_30_meal_exp_ctr, 'null')),'\002',
        concat('recent_30_meal_exp_cnt','\003', if(recent_30_meal_exp_cnt is not null, recent_30_meal_exp_cnt, 'null')),'\002',
        concat('recent_30_aftertea_exp_ctr','\003', if(recent_30_aftertea_exp_ctr is not null, recent_30_aftertea_exp_ctr, 'null')),'\002',
        concat('recent_30_aftertea_exp_cnt','\003', if(recent_30_aftertea_exp_cnt is not null, recent_30_aftertea_exp_cnt, 'null')),'\002',
        concat('recent_30_nightsnack_exp_ctr','\003', if(recent_30_nightsnack_exp_ctr is not null, recent_30_nightsnack_exp_ctr, 'null')),'\002',
